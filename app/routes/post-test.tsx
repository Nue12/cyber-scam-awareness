...
export default function PostTest() {
  ...
  const loadQuestions = async () => {
    try {
      // Using same questions as pre-test for demo
      // In production, you'd have different questions
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setPostTestAnswers(userAnswers);
      ...
      <div className="max-w-3xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Let's see how much you've learned! This will measure your
            improvement.
          </p>
        </div>
